...
public class NecesidadesGanado extends javax.swing.JPanel {
    ...
    public void verTareas(){
        StringBuilder sb = new StringBuilder();
            ...
            for(int i = 0; i<gestorTareas.necesidadesAnimales.length(); i++){
                if(gestorTareas.necesidadesAnimales != null){
                    sb.append("ID: ").append(gestorTareas.necesidadesAnimales.find(i).getId()).append("\n");               
                    sb.append("Descripción: ").append(gestorTareas.necesidadesAnimales.find(i).getDescripcion()).append("\n");               
                    sb.append("Completado: ").append(String.valueOf(gestorTareas.necesidadesAnimales.find(i).isCompletada())).append("\n"); 
                    sb.append("\n");
                }                      
            }
    ...
    private void initComponents() {
        ...
        bBuscarNecAnimal = new javax.swing.JButton();
        ...
        bBuscarNecAnimal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bBuscarNecAnimalActionPerformed(evt);
            }
        });
        add(bBuscarNecAnimal, new org.netbeans.lib.awtextra.AbsoluteConstraints(663, 60, -1, -1));
    ...
    private void bBuscarNecAnimalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bBuscarNecAnimalActionPerformed
        Tarea tarea = gestorTareas.buscarNecesidadAnimal(jtIdNec.getText());
        if(tarea != null){
    ...
    }//GEN-LAST:event_bBuscarNecAnimalActionPerformed
    ...
    private void bAgregarNecActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAgregarNecActionPerformed
        gestorTareas.agregarNecesidadAnimal(jtIdCRUD.getText(), jtDescripcionCRUD.getText());
        verTareas();
    ...
    private void bEncolarTareaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bEncolarTareaActionPerformed
        Tarea tarea = gestorTareas.buscarNecesidadAnimal(jtIdEncolar.getText());
        if(tarea != null){
    ...
    private javax.swing.JButton bBuscarNecAnimal;
