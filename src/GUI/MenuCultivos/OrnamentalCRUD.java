 ...
 * @author CristianM
 */
public class OrnamentalCRUD extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        bAgregarCereal.setText("Agregar Ornamental");
        bAgregarCereal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bAgregarCerealActionPerformed(evt);
            }
        });
        add(bAgregarCereal, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 90, -1, -1));

        bActualizarCereal.setText("Actualizar Ornamental");
        bActualizarCereal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bActualizarCerealActionPerformed(evt);
            }
        });
        add(bActualizarCereal, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 130, -1, -1));

        bEliminarCereal.setText("Eliminar Ornamental");
        bEliminarCereal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bEliminarCerealActionPerformed(evt);
            }
        });
        add(bEliminarCereal, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 170, -1, -1));
        ...
        jLabel5.setText("Gestion de ornamental");
    ...
    private void bBuscarCerealActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bBuscarCerealActionPerformed
        Ornamental ornamental = gestorCultivos.buscarIdOrnamental(jtIdCereal.getText());
        if(ornamental != null){
            jtIdCRUD.setText(ornamental.getId());
            jtNombreCRUD.setText(ornamental.getNombre());
            jtTipoCRUD.setText(ornamental.getTipo());
            
            StringBuilder sb = new StringBuilder();
            
            for(int i = 0; i<ornamental.getNecesidades().length(); i++){
                if(ornamental.getNecesidades() != null){
                    sb.append("ID: ").append(ornamental.getNecesidades().find(i).getId()).append("\n");               
                    sb.append("Descripción: ").append(ornamental.getNecesidades().find(i).getDescripcion()).append("\n");               
                    sb.append("Completado: ").append(String.valueOf(ornamental.getNecesidades().find(i).isCompletada())).append("\n"); 
                    sb.append("\n");
                }                      
            }
            ...
            JOptionPane.showMessageDialog(this, "Ornamental encontrada exitosamente!");            
        }else{
            jtIdCRUD.setText("");
            jtNombreCRUD.setText("");
            jtTipoCRUD.setText("");
            jtNecesidadesCRUD.setText("");
            JOptionPane.showMessageDialog(this, "Ornamental no encontrada!");  
        }
    ...
    private void bEliminarCerealActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bEliminarCerealActionPerformed
        Ornamental ornamental = gestorCultivos.buscarIdOrnamental(jtIdCRUD.getText());
        if(ornamental != null){
            gestorCultivos.eliminarOrnamental(jtIdCRUD.getText());
            jtIdCRUD.setText("");
            jtNombreCRUD.setText("");
            jtTipoCRUD.setText("");
            jtNecesidadesCRUD.setText("");
            JOptionPane.showMessageDialog(this, "Ornamental eliminada exitosamente!");
        }else{
            JOptionPane.showMessageDialog(this, "Ornamental no encontrada, no se realizo eliminación!");
        } 
    ...
    private void bAgregarCerealActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAgregarCerealActionPerformed
        gestorCultivos.agregarOrnamental(jtIdCRUD.getText(), jtNombreCRUD.getText(), gestorTareas.necesidadesCultivos);
        JOptionPane.showMessageDialog(this, "Ornamental agregado exitosamente!");
    ...
    private void bActualizarCerealActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bActualizarCerealActionPerformed
        Ornamental ornamental = gestorCultivos.buscarIdOrnamental(jtIdCRUD.getText());
        if(ornamental != null){
            gestorCultivos.actualizarOrnamentalNombre(ornamental.getId(), jtNombreCRUD.getText());
            gestorCultivos.actualizarOrnamentalNecesidades(ornamental.getId(), gestorTareas.necesidadesCultivos);
            jtIdCRUD.setText("");
            jtNombreCRUD.setText("");
            jtTipoCRUD.setText("");
            jtNecesidadesCRUD.setText("");
            JOptionPane.showMessageDialog(this, "Ornamental actualizado exitosamente!");
        }else{
            JOptionPane.showMessageDialog(this, "Ornamental no encontrado, no se realizo actualización!");
        }    
