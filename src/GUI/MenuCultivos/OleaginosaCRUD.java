 ...
 * @author CristianM
 */
public class OleaginosaCRUD extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        bAgregarCereal.setText("Agregar Oleaginosa");
        bAgregarCereal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bAgregarCerealActionPerformed(evt);
            }
        });
        add(bAgregarCereal, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 90, -1, -1));

        bActualizarCereal.setText("Actualizar Oleaginosa");
        bActualizarCereal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bActualizarCerealActionPerformed(evt);
            }
        });
        add(bActualizarCereal, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 130, -1, -1));

        bEliminarCereal.setText("Eliminar Oleaginosa");
        bEliminarCereal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bEliminarCerealActionPerformed(evt);
            }
        });
        add(bEliminarCereal, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 170, -1, -1));
        ...
        jLabel5.setText("Gestion de oleaginosas");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 10, -1, 20));
    ...
    private void bBuscarCerealActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bBuscarCerealActionPerformed
        Oleaginosa oleaginosa = gestorCultivos.buscarIdOleaginosa(jtIdCereal.getText());
        if(oleaginosa != null){
            jtIdCRUD.setText(oleaginosa.getId());
            jtNombreCRUD.setText(oleaginosa.getNombre());
            jtTipoCRUD.setText(oleaginosa.getTipo());
            
            StringBuilder sb = new StringBuilder();
            
            for(int i = 0; i<oleaginosa.getNecesidades().length(); i++){
                if(oleaginosa.getNecesidades() != null){
                    sb.append("ID: ").append(oleaginosa.getNecesidades().find(i).getId()).append("\n");               
                    sb.append("Descripción: ").append(oleaginosa.getNecesidades().find(i).getDescripcion()).append("\n");               
                    sb.append("Completado: ").append(String.valueOf(oleaginosa.getNecesidades().find(i).isCompletada())).append("\n"); 
                    sb.append("\n");
                }                      
            }
            ...
            JOptionPane.showMessageDialog(this, "Oleaginosa encontrada exitosamente!");            
        }else{
            jtIdCRUD.setText("");
            jtNombreCRUD.setText("");
            jtTipoCRUD.setText("");
            jtNecesidadesCRUD.setText("");
            JOptionPane.showMessageDialog(this, "Oleaginosa no encontrada!");  
        }
    ...
    private void bEliminarCerealActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bEliminarCerealActionPerformed
        Oleaginosa oleaginosa = gestorCultivos.buscarIdOleaginosa(jtIdCRUD.getText());
        if(oleaginosa != null){
            gestorCultivos.eliminarOleaginosa(jtIdCRUD.getText());
            jtIdCRUD.setText("");
            jtNombreCRUD.setText("");
            jtTipoCRUD.setText("");
            jtNecesidadesCRUD.setText("");
            JOptionPane.showMessageDialog(this, "Oleaginosa eliminada exitosamente!");
        }else{
            JOptionPane.showMessageDialog(this, "Oleaginosa no encontrada, no se realizo eliminación!");
        } 
    ...
    private void bAgregarCerealActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAgregarCerealActionPerformed
        gestorCultivos.agregarOleaginosa(jtIdCRUD.getText(), jtNombreCRUD.getText(), gestorTareas.necesidadesCultivos);
        JOptionPane.showMessageDialog(this, "Oleaginosa agregada exitosamente!");
    ...
    private void bActualizarCerealActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bActualizarCerealActionPerformed
        Oleaginosa oleaginosa = gestorCultivos.buscarIdOleaginosa(jtIdCRUD.getText());
        if(oleaginosa != null){
            gestorCultivos.actualizarOleaginosaNombre(oleaginosa.getId(), jtNombreCRUD.getText());
            gestorCultivos.actualizarOleaginosaNecesidades(oleaginosa.getId(), gestorTareas.necesidadesCultivos);
            jtIdCRUD.setText("");
            jtNombreCRUD.setText("");
            jtTipoCRUD.setText("");
            jtNecesidadesCRUD.setText("");
            JOptionPane.showMessageDialog(this, "Oleaginosa actualizada exitosamente!");
        }else{
            JOptionPane.showMessageDialog(this, "Oleaginosa no encontrada, no se realizo actualización!");
        }    
