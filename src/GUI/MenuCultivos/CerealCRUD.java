 ...
 * @author CristianM
 */
public class CerealCRUD extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        bAgregarCereal.setText("Agregar Cereal");
        ...
        bActualizarCereal.setText("Actualizar Cereal");
        ...
        bEliminarCereal.setText("Eliminar Cereal");
        ...
        jLabel5.setText("Gestion de cereales");
    ...
    private void bBuscarCerealActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bBuscarCerealActionPerformed
        Cereal cereal = gestorCultivos.buscarIdCereal(jtIdCereal.getText());
        if(cereal != null){
            jtIdCRUD.setText(cereal.getId());
            jtNombreCRUD.setText(cereal.getNombre());
            jtTipoCRUD.setText(cereal.getTipo());
            
            StringBuilder sb = new StringBuilder();
            
            for(int i = 0; i<cereal.getNecesidades().length(); i++){
                if(cereal.getNecesidades() != null){
                    sb.append("ID: ").append(cereal.getNecesidades().find(i).getId()).append("\n");               
                    sb.append("Descripción: ").append(cereal.getNecesidades().find(i).getDescripcion()).append("\n");               
                    sb.append("Completado: ").append(String.valueOf(cereal.getNecesidades().find(i).isCompletada())).append("\n"); 
                    sb.append("\n");
                }                      
            }
            ...
            JOptionPane.showMessageDialog(this, "Cereal encontrado exitosamente!");            
        }else{
            jtIdCRUD.setText("");
            jtNombreCRUD.setText("");
            jtTipoCRUD.setText("");
            jtNecesidadesCRUD.setText("");
            JOptionPane.showMessageDialog(this, "Cereal no encontrado!");  
        }
    ...
    private void bEliminarCerealActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bEliminarCerealActionPerformed
        Cereal cereal = gestorCultivos.buscarIdCereal(jtIdCRUD.getText());
        if(cereal != null){
            gestorCultivos.eliminarCereal(jtIdCRUD.getText());
            jtIdCRUD.setText("");
            jtNombreCRUD.setText("");
            jtTipoCRUD.setText("");
            jtNecesidadesCRUD.setText("");
            JOptionPane.showMessageDialog(this, "Cereal eliminado exitosamente!");
        }else{
            JOptionPane.showMessageDialog(this, "Cereal no encontrado, no se realizo eliminación!");
        } 
    ...
    private void bAgregarCerealActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAgregarCerealActionPerformed
        gestorCultivos.agregarCereal(jtIdCRUD.getText(), jtNombreCRUD.getText(), gestorTareas.necesidadesCultivos);
        JOptionPane.showMessageDialog(this, "Cereal agregado exitosamente!");
    ...
    private void bActualizarCerealActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bActualizarCerealActionPerformed
        Cereal cereal = gestorCultivos.buscarIdCereal(jtIdCRUD.getText());
        if(cereal != null){
            gestorCultivos.actualizarCerealNombre(cereal.getId(), jtNombreCRUD.getText());
            gestorCultivos.actualizarCerealNecesidades(cereal.getId(), gestorTareas.necesidadesCultivos);
            jtIdCRUD.setText("");
            jtNombreCRUD.setText("");
            jtTipoCRUD.setText("");
            jtNecesidadesCRUD.setText("");
            JOptionPane.showMessageDialog(this, "Cereal actualizado exitosamente!");
        }else{
            JOptionPane.showMessageDialog(this, "Cereal no encontrado, no se realizo actualización!");
        }    
