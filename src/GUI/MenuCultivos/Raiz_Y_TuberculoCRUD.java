 ...
 * @author CristianM
 */
public class Raiz_Y_TuberculoCRUD extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        bAgregarCereal.setText("Agregar raíz o tubérculo");
        bAgregarCereal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bAgregarCerealActionPerformed(evt);
            }
        });
        add(bAgregarCereal, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 90, -1, -1));

        bActualizarCereal.setText("Actualizar raíz o tubérculo");
        bActualizarCereal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bActualizarCerealActionPerformed(evt);
            }
        });
        add(bActualizarCereal, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 130, -1, -1));

        bEliminarCereal.setText("Eliminar raíz o tubérculo");
        bEliminarCereal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bEliminarCerealActionPerformed(evt);
            }
        });
        add(bEliminarCereal, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 170, -1, -1));
        ...
        jLabel5.setText("Gestion de raíz o tubérculo");
    ...
    private void bBuscarCerealActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bBuscarCerealActionPerformed
        Raiz_y_Tuberculo raiz_y_Tuberculo = gestorCultivos.buscarIdRaiz_y_Tuberculo(jtIdCereal.getText());
        if(raiz_y_Tuberculo != null){
            jtIdCRUD.setText(raiz_y_Tuberculo.getId());
            jtNombreCRUD.setText(raiz_y_Tuberculo.getNombre());
            jtTipoCRUD.setText(raiz_y_Tuberculo.getTipo());
            
            StringBuilder sb = new StringBuilder();
            
            for(int i = 0; i<raiz_y_Tuberculo.getNecesidades().length(); i++){
                if(raiz_y_Tuberculo.getNecesidades() != null){
                    sb.append("ID: ").append(raiz_y_Tuberculo.getNecesidades().find(i).getId()).append("\n");               
                    sb.append("Descripción: ").append(raiz_y_Tuberculo.getNecesidades().find(i).getDescripcion()).append("\n");               
                    sb.append("Completado: ").append(String.valueOf(raiz_y_Tuberculo.getNecesidades().find(i).isCompletada())).append("\n"); 
                    sb.append("\n");
                }                      
            }
            ...
            JOptionPane.showMessageDialog(this, "Raiz o Tubérculo encontrado exitosamente!");            
        }else{
            jtIdCRUD.setText("");
            jtNombreCRUD.setText("");
            jtTipoCRUD.setText("");
            jtNecesidadesCRUD.setText("");
            JOptionPane.showMessageDialog(this, "Raíz o Tubérculo no encontrado!");  
        }
    ...
    private void bEliminarCerealActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bEliminarCerealActionPerformed
        Raiz_y_Tuberculo raiz_y_Tuberculo = gestorCultivos.buscarIdRaiz_y_Tuberculo(jtIdCRUD.getText());
        if(raiz_y_Tuberculo != null){
            gestorCultivos.eliminarRaiz_y_Tuberculo(jtIdCRUD.getText());
            jtIdCRUD.setText("");
            jtNombreCRUD.setText("");
            jtTipoCRUD.setText("");
            jtNecesidadesCRUD.setText("");
            JOptionPane.showMessageDialog(this, "Raíz o Tubérculo eliminado exitosamente!");
        }else{
            JOptionPane.showMessageDialog(this, "Raíz o Tubérculo no encontrado, no se realizo eliminación!");
        } 
    ...
    private void bAgregarCerealActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAgregarCerealActionPerformed
        gestorCultivos.agregarRaiz_y_Tuberculo(jtIdCRUD.getText(), jtNombreCRUD.getText(), gestorTareas.necesidadesCultivos);
        JOptionPane.showMessageDialog(this, "Raíz o Tubérculo agregado exitosamente!");
    ...
    private void bActualizarCerealActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bActualizarCerealActionPerformed
        Raiz_y_Tuberculo raiz_y_Tuberculo = gestorCultivos.buscarIdRaiz_y_Tuberculo(jtIdCRUD.getText());
        if(raiz_y_Tuberculo != null){
            gestorCultivos.actualizarRaiz_y_TuberculoNombre(raiz_y_Tuberculo.getId(), jtNombreCRUD.getText());
            gestorCultivos.actualizarRaiz_y_TuberculoNecesidades(raiz_y_Tuberculo.getId(), gestorTareas.necesidadesCultivos);
            jtIdCRUD.setText("");
            jtNombreCRUD.setText("");
            jtTipoCRUD.setText("");
            jtNecesidadesCRUD.setText("");
            JOptionPane.showMessageDialog(this, "Raíz o Tubérculo actualizado exitosamente!");
        }else{
            JOptionPane.showMessageDialog(this, "Raíz o Tubérculo no encontrado, no se realizo actualización!");
        }    
