 ...
 * @author CristianM
 */
public class FrutalCRUD extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        bAgregarCereal.setText("Agregar Frutal");
        ...
        bActualizarCereal.setText("Actualizar Frutal");
        ...
        bEliminarCereal.setText("Eliminar Frutal");
        ...
        jLabel5.setText("Gestion de frutales");
    ...
    private void bBuscarCerealActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bBuscarCerealActionPerformed
        Frutal frutal = gestorCultivos.buscarIdFrutal(jtIdCereal.getText());
        if(frutal != null){
            jtIdCRUD.setText(frutal.getId());
            jtNombreCRUD.setText(frutal.getNombre());
            jtTipoCRUD.setText(frutal.getTipo());
            
            StringBuilder sb = new StringBuilder();
            
            for(int i = 0; i<frutal.getNecesidades().length(); i++){
                if(frutal.getNecesidades() != null){
                    sb.append("ID: ").append(frutal.getNecesidades().find(i).getId()).append("\n");               
                    sb.append("Descripción: ").append(frutal.getNecesidades().find(i).getDescripcion()).append("\n");               
                    sb.append("Completado: ").append(String.valueOf(frutal.getNecesidades().find(i).isCompletada())).append("\n"); 
                    sb.append("\n");
                }                      
            }
            ...
            JOptionPane.showMessageDialog(this, "Frutal encontrado exitosamente!");            
        }else{
            jtIdCRUD.setText("");
            jtNombreCRUD.setText("");
            jtTipoCRUD.setText("");
            jtNecesidadesCRUD.setText("");
            JOptionPane.showMessageDialog(this, "Frutal no encontrado!");  
        }
    ...
    private void bEliminarCerealActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bEliminarCerealActionPerformed
        Frutal frutal = gestorCultivos.buscarIdFrutal(jtIdCRUD.getText());
        if(frutal != null){
            gestorCultivos.eliminarFrutal(jtIdCRUD.getText());
            jtIdCRUD.setText("");
            jtNombreCRUD.setText("");
            jtTipoCRUD.setText("");
            jtNecesidadesCRUD.setText("");
            JOptionPane.showMessageDialog(this, "Frutal eliminado exitosamente!");
        }else{
            JOptionPane.showMessageDialog(this, "Frutal no encontrado, no se realizo eliminación!");
        } 
    ...
    private void bAgregarCerealActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAgregarCerealActionPerformed
        gestorCultivos.agregarFrutal(jtIdCRUD.getText(), jtNombreCRUD.getText(), gestorTareas.necesidadesCultivos);
        JOptionPane.showMessageDialog(this, "Frutal agregado exitosamente!");
    ...
    private void bActualizarCerealActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bActualizarCerealActionPerformed
        Frutal frutal = gestorCultivos.buscarIdFrutal(jtIdCRUD.getText());
        if(frutal != null){
            gestorCultivos.actualizarFrutalNombre(frutal.getId(), jtNombreCRUD.getText());
            gestorCultivos.actualizarFrutalNecesidades(frutal.getId(), gestorTareas.necesidadesCultivos);
            jtIdCRUD.setText("");
            jtNombreCRUD.setText("");
            jtTipoCRUD.setText("");
            jtNecesidadesCRUD.setText("");
            JOptionPane.showMessageDialog(this, "Frutal actualizado exitosamente!");
        }else{
            JOptionPane.showMessageDialog(this, "Frutal no encontrado, no se realizo actualización!");
        }    
