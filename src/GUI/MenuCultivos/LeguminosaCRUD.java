 ...
 * @author CristianM
 */
public class LeguminosaCRUD extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        bAgregarCereal.setText("Agregar Leguminosa");
        ...
        bActualizarCereal.setText("Actualizar Leguminosa");
        bActualizarCereal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bActualizarCerealActionPerformed(evt);
            }
        });
        add(bActualizarCereal, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 90, -1, -1));

        bEliminarCereal.setText("Eliminar Leguminosa");
        ...
        jLabel5.setText("Gestion de leguminosas");
    ...
    private void bBuscarCerealActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bBuscarCerealActionPerformed
        Leguminosa leguminosa = gestorCultivos.buscarIdLeguminosa(jtIdCereal.getText());
        if(leguminosa != null){
            jtIdCRUD.setText(leguminosa.getId());
            jtNombreCRUD.setText(leguminosa.getNombre());
            jtTipoCRUD.setText(leguminosa.getTipo());
            
            StringBuilder sb = new StringBuilder();
            
            for(int i = 0; i<leguminosa.getNecesidades().length(); i++){
                if(leguminosa.getNecesidades() != null){
                    sb.append("ID: ").append(leguminosa.getNecesidades().find(i).getId()).append("\n");               
                    sb.append("Descripción: ").append(leguminosa.getNecesidades().find(i).getDescripcion()).append("\n");               
                    sb.append("Completado: ").append(String.valueOf(leguminosa.getNecesidades().find(i).isCompletada())).append("\n"); 
                    sb.append("\n");
                }                      
            }
            ...
            JOptionPane.showMessageDialog(this, "Leguminosa encontrada exitosamente!");            
        }else{
            jtIdCRUD.setText("");
            jtNombreCRUD.setText("");
            jtTipoCRUD.setText("");
            jtNecesidadesCRUD.setText("");
            JOptionPane.showMessageDialog(this, "Leguminosa no encontrada!");  
        }
    ...
    private void bEliminarCerealActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bEliminarCerealActionPerformed
        Leguminosa leguminosa = gestorCultivos.buscarIdLeguminosa(jtIdCRUD.getText());
        if(leguminosa != null){
            gestorCultivos.eliminarLeguminosa(jtIdCRUD.getText());
            jtIdCRUD.setText("");
            jtNombreCRUD.setText("");
            jtTipoCRUD.setText("");
            jtNecesidadesCRUD.setText("");
            JOptionPane.showMessageDialog(this, "Leguminosa eliminada exitosamente!");
        }else{
            JOptionPane.showMessageDialog(this, "Leguminosa no encontrada, no se realizo eliminación!");
        } 
    ...
    private void bAgregarCerealActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAgregarCerealActionPerformed
        gestorCultivos.agregarLeguminosa(jtIdCRUD.getText(), jtNombreCRUD.getText(), gestorTareas.necesidadesCultivos);
        JOptionPane.showMessageDialog(this, "Leguminosa agregada exitosamente!");
    ...
    private void bActualizarCerealActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bActualizarCerealActionPerformed
        Leguminosa leguminosa = gestorCultivos.buscarIdLeguminosa(jtIdCRUD.getText());
        if(leguminosa != null){
            gestorCultivos.actualizarLeguminosaNombre(leguminosa.getId(), jtNombreCRUD.getText());
            gestorCultivos.actualizarLeguminosaNecesidades(leguminosa.getId(), gestorTareas.necesidadesCultivos);
            jtIdCRUD.setText("");
            jtNombreCRUD.setText("");
            jtTipoCRUD.setText("");
            jtNecesidadesCRUD.setText("");
            JOptionPane.showMessageDialog(this, "Leguminosa actualizada exitosamente!");
        }else{
            JOptionPane.showMessageDialog(this, "Leguminosa no encontrada, no se realizo actualización!");
        }    
