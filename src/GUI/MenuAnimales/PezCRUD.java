 ...
 * @author CristianM
 */
public class PezCRUD extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        bActualizarAve.setText("Actualizar Pez");
    ...
    private void bBusquedaAveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bBusquedaAveActionPerformed
        ...
        Pez pez = gestorAnimales.buscarIdPez(id);
        
        if(pez != null){
            jtIdCRUD.setText(pez.getId());
            jtEdadCRUD.setText(String.valueOf(pez.getEdad()));
            jtSaludCRUD.setText(pez.getSalud());
            jtPesoCRUD.setText(String.valueOf(pez.getPeso()));
            jtTipoCRUD.setText(pez.getTipo());
            JOptionPane.showMessageDialog(this, "Pez encontrado exitosamente!");
        }else{
            jtIdCRUD.setText("");
            jtEdadCRUD.setText("");
            jtSaludCRUD.setText("");
            jtPesoCRUD.setText("");
            jtTipoCRUD.setText("");
            JOptionPane.showMessageDialog(this, "Pez no encontrado!");
        }
    ...
    private void bAgregarAveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAgregarAveActionPerformed
        gestorAnimales.agregarPez(jtIdCRUD.getText(), Integer.parseInt(jtEdadCRUD.getText()), jtSaludCRUD.getText(), Double.parseDouble(jtPesoCRUD.getText()));
        JOptionPane.showMessageDialog(this, "Pez agregado exitosamente!");
    ...
    private void bBorrarAveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bBorrarAveActionPerformed
        Pez pez = gestorAnimales.buscarIdPez(jtIdCRUD.getText());
        if(pez != null){
            gestorAnimales.eliminarPez(jtIdCRUD.getText());
            jtIdCRUD.setText("");
            jtEdadCRUD.setText("");
            jtSaludCRUD.setText("");
            jtPesoCRUD.setText("");
            jtTipoCRUD.setText("");
            JOptionPane.showMessageDialog(this, "Pez eliminado exitosamente!");
        }else{
            JOptionPane.showMessageDialog(this, "Pez no encontrado, no se realizo eliminación!");
        }         
    ...
    private void bActualizarAveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bActualizarAveActionPerformed
        Pez pez = gestorAnimales.buscarIdPez(jtIdCRUD.getText());
        if(pez != null){
            gestorAnimales.actualizarPezEdad(pez.getId(), Integer.parseInt(jtEdadCRUD.getText()));
            gestorAnimales.actualizarPezSalud(pez.getId(), jtSaludCRUD.getText());
            gestorAnimales.actualizarPezPeso(pez.getId(), Double.parseDouble(jtPesoCRUD.getText()));
            jtIdCRUD.setText("");
            jtEdadCRUD.setText("");
            jtSaludCRUD.setText("");
            jtPesoCRUD.setText("");
            jtTipoCRUD.setText("");
            JOptionPane.showMessageDialog(this, "Pez actualizado exitosamente!");
        }else{
            JOptionPane.showMessageDialog(this, "Pez no encontrado, no se realizo actualización!");
        }    
