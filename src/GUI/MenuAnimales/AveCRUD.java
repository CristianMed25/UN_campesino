 ...
 * @author CristianM
 */
public class AveCRUD extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        bAgregarAve.setText("Agregar Ave");
    ...
    private void bBusquedaAveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bBusquedaAveActionPerformed
        ...
        Ave ave = gestorAnimales.buscarIdAve(id);
        
        if(ave != null){
            jtIdCRUD.setText(ave.getId());
            jtEdadCRUD.setText(String.valueOf(ave.getEdad()));
            jtSaludCRUD.setText(ave.getSalud());
            jtPesoCRUD.setText(String.valueOf(ave.getPeso()));
            jtTipoCRUD.setText(ave.getTipo());
            JOptionPane.showMessageDialog(this, "Ave encontrada exitosamente!");
        }else{
            jtIdCRUD.setText("");
            jtEdadCRUD.setText("");
            jtSaludCRUD.setText("");
            jtPesoCRUD.setText("");
            jtTipoCRUD.setText("");
            JOptionPane.showMessageDialog(this, "Ave no encontrada!");
        }
    ...
    private void bAgregarAveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAgregarAveActionPerformed
        gestorAnimales.agregarAve(jtIdCRUD.getText(), Integer.parseInt(jtEdadCRUD.getText()), jtSaludCRUD.getText(), Double.parseDouble(jtPesoCRUD.getText()));
        JOptionPane.showMessageDialog(this, "Ave agregada exitosamente!");
    ...
    private void bBorrarAveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bBorrarAveActionPerformed
        Ave ave = gestorAnimales.buscarIdAve(jtIdCRUD.getText());
        if(ave != null){
            gestorAnimales.eliminarAve(jtIdCRUD.getText());
            jtIdCRUD.setText("");
            jtEdadCRUD.setText("");
            jtSaludCRUD.setText("");
            jtPesoCRUD.setText("");
            jtTipoCRUD.setText("");
            JOptionPane.showMessageDialog(this, "Ave eliminada exitosamente!");
        }else{
            JOptionPane.showMessageDialog(this, "Ave no encontrada, no se realizo eliminación!");
        }         
    ...
    private void bActualizarAveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bActualizarAveActionPerformed
        Ave ave = gestorAnimales.buscarIdAve(jtIdCRUD.getText());
        if(ave != null){
            gestorAnimales.actualizarAveEdad(ave.getId(), Integer.parseInt(jtEdadCRUD.getText()));
            gestorAnimales.actualizarAveSalud(ave.getId(), jtSaludCRUD.getText());
            gestorAnimales.actualizarAvePeso(ave.getId(), Double.parseDouble(jtPesoCRUD.getText()));
            jtIdCRUD.setText("");
            jtEdadCRUD.setText("");
            jtSaludCRUD.setText("");
            jtPesoCRUD.setText("");
            jtTipoCRUD.setText("");
            JOptionPane.showMessageDialog(this, "Ave actualizada exitosamente!");
        }else{
            JOptionPane.showMessageDialog(this, "Ave no encontrada, no se realizo actualización!");
        }    
