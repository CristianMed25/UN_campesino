 ...
 * @author CristianM
 */
public class CaballoCRUD extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        bAgregarAve.setText("Agregar Caballo");
        ...
        bActualizarAve.setText("Actualizar Caballo");
    ...
    private void bBusquedaAveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bBusquedaAveActionPerformed
        ...
        Caballo caballo = gestorAnimales.buscarIdCaballo(id);
        
        if(caballo != null){
            jtIdCRUD.setText(caballo.getId());
            jtEdadCRUD.setText(String.valueOf(caballo.getEdad()));
            jtSaludCRUD.setText(caballo.getSalud());
            jtPesoCRUD.setText(String.valueOf(caballo.getPeso()));
            jtTipoCRUD.setText(caballo.getTipo());
            JOptionPane.showMessageDialog(this, "Caballo encontrado exitosamente!");
        }else{
            jtIdCRUD.setText("");
            jtEdadCRUD.setText("");
            jtSaludCRUD.setText("");
            jtPesoCRUD.setText("");
            jtTipoCRUD.setText("");
            JOptionPane.showMessageDialog(this, "Caballo no encontrado!");
        }
    ...
    private void bAgregarAveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAgregarAveActionPerformed
        gestorAnimales.agregarCaballo(jtIdCRUD.getText(), Integer.parseInt(jtEdadCRUD.getText()), jtSaludCRUD.getText(), Double.parseDouble(jtPesoCRUD.getText()));
        JOptionPane.showMessageDialog(this, "Caballo agregado exitosamente!");
    ...
    private void bBorrarAveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bBorrarAveActionPerformed
        Caballo caballo = gestorAnimales.buscarIdCaballo(jtIdCRUD.getText());
        if(caballo != null){
            gestorAnimales.eliminarCaballo(jtIdCRUD.getText());
            jtIdCRUD.setText("");
            jtEdadCRUD.setText("");
            jtSaludCRUD.setText("");
            jtPesoCRUD.setText("");
            jtTipoCRUD.setText("");
            JOptionPane.showMessageDialog(this, "Caballo eliminado exitosamente!");
        }else{
            JOptionPane.showMessageDialog(this, "Caballo no encontrado, no se realizo eliminación!");
        }         
    ...
    private void bActualizarAveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bActualizarAveActionPerformed
        Caballo caballo = gestorAnimales.buscarIdCaballo(jtIdCRUD.getText());
        if(caballo != null){
            gestorAnimales.actualizarCaballoEdad(caballo.getId(), Integer.parseInt(jtEdadCRUD.getText()));
            gestorAnimales.actualizarCaballoSalud(caballo.getId(), jtSaludCRUD.getText());
            gestorAnimales.actualizarCaballoPeso(caballo.getId(), Double.parseDouble(jtPesoCRUD.getText()));
            jtIdCRUD.setText("");
            jtEdadCRUD.setText("");
            jtSaludCRUD.setText("");
            jtPesoCRUD.setText("");
            jtTipoCRUD.setText("");
            JOptionPane.showMessageDialog(this, "Caballo actualizado exitosamente!");
        }else{
            JOptionPane.showMessageDialog(this, "Caballo no encontrado, no se realizo actualización!");
        }    
